...
export const fr: Translations = {
  ...
  chat: {
    newChat: "New Chat",
    welcome: "Hi! I am vbit Agent, how can I help?",
    placeholder: "Type a message…",
    powered: "Local AI Assistant",
    noConversation: "Start a new conversation",
  },
  status: {
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les vbt Agent plugins (parité avec `vermes plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.vermes/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.vermes/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.vermes/skills/",
  ...
  achievements: {
    hero: {
      kicker: "Agent Gamerscore",
      title: "vbit Agent Achievements",
      subtitle:
        "Badges vbit Agent à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions vbit Agent en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez vbit Agent davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès que vbit Agent détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "vbit Agent analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in vbit Agent ⚡",
    },
  },
  kanban: {
