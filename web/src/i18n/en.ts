...
export const en: Translations = {
  ...
  chat: {
    newChat: "New Chat",
    welcome: "Hi! I'm vbit Agent, how can I help?",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update vbit Agent plugins (`vermes plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.vermes/plugins/?",
    removeHint: "Only user-installed plugins under ~/.vermes/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.vermes/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible vbit Agent badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning vbit Agent session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run vbit Agent more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once vbit Agent sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "vbit Agent is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
