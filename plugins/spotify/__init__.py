...
``_check_spotify_available()`` — when the user has not run ``vermes auth
spotify``, the tools remain registered (so they appear in ``Vermes
...
The Spotify auth flow (``vermes auth spotify``), CLI plumbing, and docs
