...
Trust levels:
  - builtin:   Ships with Vermes. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.vermes/\.env|\~/\.vermes/\.env',
     "VERMES_env_access", "critical", "exfiltration",
     "directly references Vermes secrets file"),
    ...
    (r'\.vermes/config\.yaml|\.vermes/SOUL\.md',
     "VERMES_config_mod", "critical", "persistence",
     "references Vermes configuration files directly"),
