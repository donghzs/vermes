...
_FORCE_SYNC_ENV = "VERMES_FORCE_FILE_SYNC"
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``VERMES_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, VERMES_home: Path | None = None) -> None:
        """Pull remote changes back to the host filesystem.

        Downloads the remote ``.vermes/`` directory as a tar archive,
    ...
    def _sync_back_impl(self) -> None:
        ...
        with tempfile.NamedTemporaryFile(suffix=".tar") as tf:
            ...
            with tempfile.TemporaryDirectory(prefix="Vermes-sync-back-") as staging:
