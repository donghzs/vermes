...
def _profile_user_agent() -> str:
    """Return a ``Vermes-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from vermes_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"Vermes-cli/{_ver}"
    except Exception:
        return "Vermes-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # Vermes-cli UA so the catalog endpoint is reachable.
