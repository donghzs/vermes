...
DEFAULT_UA = (
    "Vermes-osint-investigation/0.2 "
    "(+https://github.com/donghzs/vermes; "
    "set VERMES_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("VERMES_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
