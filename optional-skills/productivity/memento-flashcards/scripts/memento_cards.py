...
Data file: $VERMES_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_vermes_HOME = Path(os.environ.get("VERMES_HOME", Path.home() / ".vermes"))
DATA_DIR = _vermes_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
