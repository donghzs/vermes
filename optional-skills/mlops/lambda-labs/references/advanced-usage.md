...
if gpu_type:
    ...
    print(f"Ready: ssh REDACTED_USER@{instance['ip']}")
```
...
ssh REDACTED_USER@<IP> "echo '$(cat ~/.ssh/lambda_key_new.pub)' >> ~/.ssh/authorized_keys"

# Test new key
ssh -i ~/.ssh/lambda_key_new REDACTED_USER@<IP>
