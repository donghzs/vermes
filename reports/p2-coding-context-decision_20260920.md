...
> **⚠️ SUPERSEDED（2026-09-20）**  
> 董董两次纠偏（渠道=承载；全世界皆 code + 记忆底座跨渠道跨会话）之后，本文件的「加法/减法 / coding 姿态」框架已被证伪。  
> **唯一真源**：`reports/qclaw/p2-coding-context-qclaw-终局立场_20260920.md`  
> **MiMo 立场**：见该文件 §6 附录；**同意终局三条**（P2 永久不做 / A′ 降格安全补丁 / M7 触发改 token 长度待拍板）。  
> 本文件仅作历史对照，**勿再据此排期或改代码**。
