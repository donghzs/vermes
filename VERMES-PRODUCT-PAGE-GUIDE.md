...
```bash
# 写好 HTML 后上传
scp /tmp/vermes-product.html REDACTED_USER@REDACTED_SERVER_IP:/tmp/vermes-product.html
ssh REDACTED_USER@REDACTED_SERVER_IP "cp /tmp/vermes-product.html /var/www/html/vermes/index.html"
```

### 灾难恢复
```bash
# 从备份恢复
scp ~/Projects/vermes/VERMES-PRODUCT-PAGE-BACKUP.html REDACTED_USER@REDACTED_SERVER_IP:/tmp/vermes-product.html
ssh REDACTED_USER@REDACTED_SERVER_IP "cp /tmp/vermes-product.html /var/www/html/vermes/index.html"
```
