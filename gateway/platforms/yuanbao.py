...
try:
    ...
    _vermes_VERSION = "0.0.0"

_APP_VERSION = _vermes_VERSION
_BOT_VERSION = _vermes_VERSION
_YUANBAO_INSTANCE_ID = str(VERMES_INSTANCE_ID)  # single source: yuanbao_proto.VERMES_INSTANCE_ID
