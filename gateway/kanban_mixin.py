"""Kanban mixin extracted from GatewayRunner.

Contains all kanban-related watcher and command methods.
"""
...
class KanbanMixin:
    """Kanban watcher and command methods extracted from GatewayRunner."""
        ...
        while self._running:
            try:
                def _collect():
                    ...
                    # VERMES_KANBAN_DB pins the board path; without this guard
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        # watcher here. Honours VERMES_KANBAN_DISPATCH_IN_GATEWAY env var
        ...
        try:
            ...
            return
        env_override = os.environ.get("VERMES_KANBAN_DISPATCH_IN_GATEWAY", "").strip().lower()
        if env_override in {"0", "false", "no", "off"}:
            logger.info("kanban dispatcher: disabled via VERMES_KANBAN_DISPATCH_IN_GATEWAY env")
            return
        ...
        def _auto_decompose_tick() -> int:
            ...
            """
            try:
                from vermes_cli import kanban_decompose as _decomp
            ...
            for b in boards:
                ...
                try:
                    os.environ["VERMES_KANBAN_BOARD"] = slug
                    try:
