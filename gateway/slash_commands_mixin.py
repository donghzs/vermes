"""SlashCommandsMixin extracted from GatewayRunner.

Contains all /command handler methods. Functions are imported from
gateway.gateway_utils; module-level variables (_hermes_home,
_AGENT_PENDING_SENTINEL, etc.) are lazily imported from gateway.run
inside methods to support test monkeypatching.
"""
...
class SlashCommandsMixin:
    """All /command handler methods extracted from GatewayRunner."""
