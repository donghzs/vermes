...
VERMES_HOME = Path(os.getenv("VERMES_HOME", Path.home() / ".vermes"))
...
def check_config(groq_key, eleven_key):
    ...
    # Voice mode state
    voice_mode_path = VERMES_HOME / "gateway_voice_mode.json"
