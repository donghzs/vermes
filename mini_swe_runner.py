#!/usr/bin/env python3
"""
SWE Runner with Vermes Trajectory Format

A runner that uses Vermes-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Vermes-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Vermes-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Vermes format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Vermes-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Vermes-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Vermes Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Vermes-Agent's built-in execution environments
    and outputs trajectories in Vermes-Agent format.
    """
    ...
    def _convert_to_vermes_format(
        ...
        """
        Convert internal message format to Vermes trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Vermes trajectory format
        trajectory = self._convert_to_vermes_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Vermes trajectory format output.
    ...
    """
    logger.info("🚀 Mini-SWE Runner with Vermes Trajectory Format")
    logger.info("=" * 60)
