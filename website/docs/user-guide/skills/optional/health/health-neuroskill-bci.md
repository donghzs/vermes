...
| | |
|---|---|
| Source | Optional — install with `vermes skills install official/health/neuroskill-bci` |
...
Connect Vermes to a running [NeuroSkill](https://neuroskill.com/) instance to read
