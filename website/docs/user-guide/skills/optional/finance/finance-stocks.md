...
| | |
|---|---|
| Source | Optional — install with `vermes skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Vermes Agent |
| License | MIT |
...
```
SCRIPT=~/.vermes/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.vermes/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
