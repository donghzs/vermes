...
| | |
|---|---|
| Source | Optional — install with `vermes skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Vermes","productType":"Apparel","tags":["test"]}}'
```
