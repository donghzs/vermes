...
| | |
|---|---|
| Source | Optional — install with `vermes skills install official/research/qmd` |
...
Vermes Agent via the native MCP client. This is the preferred
...
Then configure Vermes Agent to connect via HTTP:
