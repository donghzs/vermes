...
- User wants **Vermes itself to drive a browser** → use Vermes' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
