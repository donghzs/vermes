...
| | |
|---|---|
| Source | Optional — install with `vermes skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Vermes Agent |
| License | MIT |
...
Helper script path: `~/.vermes/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.vermes/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.vermes/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.vermes/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
