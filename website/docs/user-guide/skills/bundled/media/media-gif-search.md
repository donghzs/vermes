...
Set your Tenor API key in your environment (add to `~/.vermes/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/donghzs/vermes/blob/main/skills/media/gif-search/url)`
