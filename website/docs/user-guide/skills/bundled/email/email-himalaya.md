...
To reply non-interactively from Vermes, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Vermes)** — pipe the message via stdin:
