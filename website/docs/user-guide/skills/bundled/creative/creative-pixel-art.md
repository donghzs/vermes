...
```python
import sys
sys.path.insert(0, "/home/teknium/.vermes/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.vermes/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Vermes installs package this)
