...
```bash
python3 -m pyfiglet "vermes" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=vermes&font=Slant" | boxes -d stone
```
