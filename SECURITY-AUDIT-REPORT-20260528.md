...
> **服务器**：`REDACTED_USER@REDACTED_SERVER_IP`  
...
- **同时修复**：硬编码 IP `REDACTED_SERVER_IP:8083` 改为 `os.environ.get("ONEAPI_URL", "http://127.0.0.1:8083")`
...
| 项目 | 值 |
|------|-----|
| SSH | `REDACTED_USER@REDACTED_SERVER_IP` / `REDACTED_PASSWORD` |
