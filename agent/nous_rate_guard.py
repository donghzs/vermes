...
(3 SDK retries x 3 Vermes retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_vermes_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".vermes")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Vermes, ...) behind one endpoint.  A 429 can mean either:
