...
projection into Vermes' display, approval bridging, transcript projection into
...
"codex_app_server"`. Vermes' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("VERMES_KANBAN_TASK"):
            kanban_db = spawn_env.get("VERMES_KANBAN_DB")
            kanban_root = (
    ...
    def initialize(
        self,
        client_name: str = "Vermes",
        client_title: str = "Vermes",
