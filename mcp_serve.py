"""
Vermes MCP Server — expose messaging conversations as MCP tools.
...
class EventBridge:
    ...
    This is the Vermes equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    """Create and return the Vermes MCP server with all tools registered."""
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the Vermes MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        logger.info(
