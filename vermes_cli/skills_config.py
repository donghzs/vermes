"""
Skills configuration for Vermes.
`vermes skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.vermes/config.yaml under:
...
from vermes_cli.config import cfg_get, load_config, save_config
from vermes_cli.colors import Colors, color
from vermes_cli.platforms import PLATFORMS as _PLATFORMS
