...
# [POC 2026-08-13] repoint to DeepSeek (only API key available in env).
# DeepSeek is OpenAI-compatible; qwen-specific thinking toggles removed.
DS_BASE_URL = "https://api.deepseek.com/v1"

# --- Stage 1: Spec Planner -----------------------------------------------
SPEC_PLANNER_MODEL = "deepseek-chat"
...
USER_REQUEST = "做一个笔筒：圆柱体，外径 60 毫米，高 100 毫米，壁厚 3 毫米，底部封闭，顶部开口。"
