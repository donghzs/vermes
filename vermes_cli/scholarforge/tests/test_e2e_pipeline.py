...
class TestProjectLifecycle(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        import vermes_cli.scholarforge.database as dbmod
    ...
    def test_update_and_delete(self):
        from vermes_cli.scholarforge.database import create_project, update_project, get_project, delete_project
...
class TestLiteratureSearchE2E(unittest.TestCase):
    ...
    def test_paper_result_roundtrip(self):
        ...
        # DB 添加文献
        from vermes_cli.scholarforge.database import create_project, add_literature, list_literature
...
Swin Transformer [3] 在医学影像中具有巨大潜力。"""
    ...
    def test_scoring_full_path(self):
        from vermes_cli.scholarforge import scoring
        async def _run():
...
"""
    ...
    def test_all_formats_no_crash(self):
        from vermes_cli.scholarforge.export.full import export_markdown, export_latex, export_docx, export_bibtex
        # Markdown
...
class TestFullPipelineDataConsistency(unittest.TestCase):
    ...
    def test_full_user_journey(self):
        ...
        delete_project(pid)
        self.assertIsNone(
            __import__('vermes_cli.scholarforge.database', fromlist=['get_project']).get_project(pid)
        )
