...
运行: python -m pytest vermes_cli/scholarforge/tests/test_api_endpoints.py -v
"""
import json
import os
import sys
...
# Setup temp DB before any vermes_cli imports
