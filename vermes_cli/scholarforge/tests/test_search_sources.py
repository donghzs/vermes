...
import vermes_cli.scholarforge.search as sf_search
from vermes_cli.scholarforge.search import (
    _SEARCH_SOURCES,
...
class TestBaiduScholarWrapperConversion(unittest.TestCase):
    def test_converts_cnki_paper_to_paper_result(self):
        ...
        import vermes_cli.scholarforge.baidu_scholar_fetcher as bsf
        from vermes_cli.scholarforge.cnki_fetcher import CnkiPaper
