...
Pure display functions with no VermesCLI state dependency.
"""
...
from vermes_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE

VERMES_AGENT_LOGO = """[bold #00FF88]██╗   ██╗███████╗██████╗ ███████╗███████╗██╗  ██╗███████╗██╗     ███████╗[/]
[bold #00FF88]██║   ██║██╔════╝██╔══██╗██╔════╝██╔════╝██║  ██║██╔════╝██║     ██╔════╝[/]
[#00DD77]██║   ██║█████╗  ██████╔╝███████╗███████╗███████║█████╗  ██║     █████╗  [/]
[#00DD77]╚██╗ ██╔╝██╔══╝  ██╔══██╗██╔════╝██╔════╝██╔══██║██╔══╝  ██║     ██╔══╝  [/]
[#00BB66] ╚████╔╝ ███████╗██║  ██║███████╗███████╗██║  ██║███████╗███████╗███████╗[/]
...
def format_banner_version_label() -> str:
    ...
    base = f"Vermes v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else VERMES_CADUCEUS
    except Exception:
        _bskin = None
        _hero = VERMES_CADUCEUS
    left_lines = ["", _hero, ""]
    ...
    try:
        from vermes_cli.codex_runtime_switch import get_current_runtime
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from vermes_cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
    ...
    _print = getattr(console, 'logger', None) or console.print
    _print()
