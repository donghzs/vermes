...
from vermes_cli.default_soul import DEFAULT_SOUL_MD
...
DEFAULT_CONFIG = {
    ...
    "memory": {
        ...
        "memory_char_limit": 5000,   # ~1800 tokens — long tasks need room
        "user_char_limit": 3000,     # ~1100 tokens
    ...
    "delegation": {
        ...
        "max_concurrent_children": 5,  # max parallel children per batch; floor of 1 enforced, no ceiling
    ...
    "whatsapp": {
        ...
        # Default (None) uses the built-in "⚕ *Vermes*" header.
...
def get_custom_provider_context_length(
    ...
    used by:
      ...
      * ``vermes_cli.model_switch.resolve_display_context_length`` (``/model`` confirmation display)
...
def set_config_value(key: str, value: str):
    ...
    logger.info(f"✓ Set {key} = {_display_value} in {config_path}")
