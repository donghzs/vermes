...
Invoked by ``vermes kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``vermes_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Vermes board.
...
def _profile_author() -> str:
    """Mirror of ``vermes_cli.kanban._profile_author``."""
    return (
