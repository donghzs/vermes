...
class TestProjectContext(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._db_patcher = patch("hermes_cli.scholarforge.database.DB_PATH", self.db_path)
        self._db_patcher.start()
        # 初始化表结构
        from hermes_cli.scholarforge.database import init_db
        init_db()
    ...
    def test_load_project_context_exists(self):
        """创建项目后能正确加载"""
        from hermes_cli.scholarforge.database import create_project
        from hermes_cli.scholarforge.project_context import load_project_context
    ...
    def test_format_project_context_prompt_has_outline(self):
        """有大纲时 prompt 包含大纲"""
        from hermes_cli.scholarforge.database import create_project, get_conn
        from hermes_cli.scholarforge.project_context import format_project_context_prompt
    ...
    def test_save_section_upsert(self):
        """重复写同一段落应更新而非插入"""
        from hermes_cli.scholarforge.database import create_project, get_conn, get_project
        from hermes_cli.scholarforge.project_context import save_section
    ...
    def test_list_active_projects(self):
        ...
        from hermes_cli.scholarforge.database import create_project
        from hermes_cli.scholarforge.project_context import list_active_projects
...
class TestSchemaHasProjectId(unittest.TestCase):
    ...
    def test_all_schemas_have_project_id(self):
        ...
        from hermes_cli.scholarforge import tools
...
class TestHandlerProjectIdParam(unittest.TestCase):
    ...
    def test_outline_handler_with_project_id(self):
        ...
        from hermes_cli.scholarforge.database import create_project, get_project
        from hermes_cli.scholarforge.tools import _handle_scholarforge_outline
