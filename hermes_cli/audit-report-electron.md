...
**文件**: `hermes_cli/web_server.py:90-94`  
...
**文件**: `hermes_cli/web_server.py:1577-1583`  
...
**文件**: `hermes_cli/blueprints/providers.py:194-199`, `hermes_cli/web_server.py:2668-2673`  
...
**文件**: `hermes_cli/web_server.py:216`  
...
**文件**: `hermes_cli/blueprints/providers.py:230-231`  
...
**文件**: `hermes_cli/blueprints/providers.py:293-294`  
...
**文件**: `hermes_cli/web_server.py:2702-2703`（旧版，与 blueprints 中重复）  
**风险**: 同上，异常信息直接返回  
**代码**:
```python
except Exception as e:
...
**文件**: `hermes_cli/web_server.py:1269`, `hermes_cli/web_server.py:1296-1306`  
...
**文件**: `hermes_cli/blueprints/providers.py:257`, `hermes_cli/blueprints/chat.py:465`  
...
**文件**: `hermes_cli/web_server.py:1580`  
...
`hermes_cli/blueprints/config.py:456-457` 中返回值使用 `redact_key(value)` 而非明文

### ✅ `/api/env/reveal` 有 Rate Limit + Session Token 保护
`hermes_cli/blueprints/config.py:493-517` 配置了每30秒最多5次 reveals

### ✅ 主机头验证中间件
`hermes_cli/web_server.py:312-339` 防止 DNS 重绑定攻击

### ✅ Provider 同步有 SSRF 保护
`hermes_cli/blueprints/providers.py:263-274` 限制仅已知 domain 可发送 API key
