...
# vermes_cli/main.py succeeds (see #18800). /opt/hermes/web is build-time
# only (HERMES_WEB_DIST points at vermes_cli/web_dist) and is intentionally
# not chowned here.
...
# ---------- Runtime ----------
ENV HERMES_WEB_DIST=/opt/hermes/vermes_cli/web_dist
