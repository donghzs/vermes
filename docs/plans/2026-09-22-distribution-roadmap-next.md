...
> 停止条件②④ 是**日历量**，机制冻结 ≠ 杮子清零。2026-09-25 时点（订正）：
> ② 首次真自动 = 9/25 09:17（已落盘），当日 red（自造假税：canary 脚本未进 ZONES.own，当场清零）
> → **3 个连续绿日从 9/26 起算 ≈ 9/28**；
> ④ 2.5.3 起算第 1 周 → 满 2–3 周 ≈ 10/8–10/15。
> 教训：门禁脚本自己也是 follow 区新文件——新建即查上游同名、进 ZONES.own。
