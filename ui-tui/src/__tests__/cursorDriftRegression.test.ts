 ...
 *
 * Symptom: in `vermes --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@vermes/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using vermes --tui and as i type multiline my caret at the end will often ' +
