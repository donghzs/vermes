...
import type { ScrollBoxHandle } from '@vermes/ink'
import { evictInkCaches } from '@vermes/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.VERMES_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
