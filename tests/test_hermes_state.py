"""Tests for vermes_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_topic_mode_schema_is_not_auto_migrated_on_open(self, tmp_path):
        ...
        The gateway must remain rollback-safe: simply upgrading Vermes and starting
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from vermes_state import SCHEMA_SQL
