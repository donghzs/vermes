...
def test_summarize_api_error_surfaces_xai_entitlement_body_verbatim():
    """xAI's OAuth 403 body must surface as-is, with no Vermes-side hint."""
    from run_agent import AIAgent
    ...
    # No stale claim that X Premium is incompatible with Vermes.
...
def test_grok_4_3_context_length_is_1m():
    ...
    Vermes' substring-match fallback used to return 256k (from the
