...
def setup_project(tmp_db):
    """创建测试项目和章节内容。"""
    from hermes_cli.scholarforge.database import create_project, save_outline, save_section_content
...
class TestReadSection:
    ...
    async def test_read_single_section(self, setup_project):
        from hermes_cli.scholarforge.tools import _handle_scholarforge_read_section
