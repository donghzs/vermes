...
def test_main_setup_runs_model_configuration(monkeypatch):
    ...
    def fake_vermes_main():
        calls["argv"] = sys.argv[:]

    monkeypatch.setattr("vermes_cli.main.main", fake_vermes_main)
...
def test_main_setup_offers_browser_install_when_tty(monkeypatch):
    ...
    monkeypatch.setattr("vermes_cli.main.main", lambda: None)
...
def test_main_setup_browser_calls_ensure_dependency(monkeypatch):
    ...
    monkeypatch.setattr("vermes_cli.dep_ensure.ensure_dependency", fake_ensure)
