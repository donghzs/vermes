...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from vermes_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in VERMES_OVERLAYS
        overlay = VERMES_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify vermes doctor recognizes Xiaomi env vars."""
