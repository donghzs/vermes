...
class TestApply:
    ...
    def test_enable_succeeds_when_codex_present(self):
        ...
        with patch.object(crs, "check_codex_binary_ok",
                          return_value=(True, "0.130.0")), \
             patch("vermes_cli.codex_runtime_plugin_migration.migrate"):
    ...
    def test_enable_triggers_mcp_migration(self):
        """Enabling codex_app_server should auto-migrate Vermes mcp_servers
        ...
        # Vermes tool callback announcement
    ...
    def test_disable_does_not_trigger_migration(self):
        ...
        with patch("vermes_cli.codex_runtime_plugin_migration.migrate") as mig:
            r = crs.apply(cfg, "auto")
        assert r.success
