...
The main() function in vermes_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `Vermes -c model`
...
def _build_parser():
    """Build a minimal replica of the Vermes top-level parser."""
