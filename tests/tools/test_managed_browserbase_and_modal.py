...
def _enable_managed_nous_tools(monkeypatch):
    ...
    vermes_cli.auth and vermes_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("vermes_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("vermes_cli.models.check_nous_free_tier", lambda: False)
