...
def test_import_loads_env_from_vermes_home(tmp_path, monkeypatch):
    home = tmp_path / ".vermes"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-Vermes-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-Vermes-home"
