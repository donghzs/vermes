  ...
  >
    ...
    <template v-else>
      ...
      <div class="p-2 border-t border-gray-200 dark:border-gray-700 grid grid-cols-4 gap-1 shrink-0">
        ...
        <button @click="goScholarForge()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] transition" :class="$route.path === '/scholarforge' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600'">
        ...
        <button @click="go3DStudio()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] transition" :class="$route.path === '/3d-studio' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600'">
          <span class="text-[15px] leading-none">🏭</span><span>3D</span>
          <span class="sidebar-tooltip group-hover:opacity-100">3D 建模工作室</span>
        </button>
        <button @click="goWorkflows()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] transition" :class="$route.path === '/workflows' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600'">
          <span class="text-[15px] leading-none">🔀</span><span>工作流</span>
          <span class="sidebar-tooltip group-hover:opacity-100">工作流编排</span>
        </button>
        <button @click="goShenmotang()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] transition" :class="$route.path === '/shenmotang' ? 'bg-indigo-500 text-white' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600'">
        ...
        <button @click="goBenchmark()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] transition" :class="$route.path === '/benchmark' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600'">
        ...
        <button @click="goMobileConnect()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] transition bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600">
        ...
        <button @click="goSettings()" class="group relative flex flex-col items-center gap-0.5 px-1 py-1 rounded-lg text-[10px] bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition">
