  ...
  <div class="studio">
    ...
    <div class="studio-layout">
      ...
      <div class="config-panel">
        ...
        <div class="form-group">
          <label>模型名</label>
          <input v-model="model" placeholder="agnes-3.0-flash" />
        </div>
...
const providerPresets = [
  { name: 'agnes', label: 'Agnes AI', icon: '🧠', baseUrl: 'https://apihub.agnes-ai.com/v1', text: 'agnes-3.0-flash', image: 'agnes-image-2.1-flash', video: 'agnes-video-v2.0', keyEnv: 'AGNES_API_KEY' },
